...
namespace PUCIT.AIMRL.WebAppName.MainApp.APIControllers
{
    class SecurityRepository
    {
        ...
        public Object EnableDisableRole(Role pRoleObj)
        {
            String msg = " ";
            try
            {
        ...
        public Object getStudents ()
        {
            try
            {
                var List = DataService.GetAllStudents ();
                return (new
                {
                    data = new
                    {
        ...
        public Object SaveStudent ( Students std )
        {
            String msg = " ";
            try
            {
                var studentId = DataService.SaveStudent ( std, DateTime.UtcNow, SessionManager.CurrentUser.UserId );
                if (std.StudentID > 0)
                {
        ...
        //public object EnableDisableStudent ( Students pStudentObj )
        //{
        //    try
        //    {
        //        String msg = "";
        //        var result = DataService.EnableDisableStudent ( pStudentObj.UserId, pStudentObj.IsActive, DateTime.UtcNow, SessionManager.CurrentUser.UserId );
        //        if (result == true)
        //        {
        //            var param = (pStudentObj.IsActive == false ? "disabled" : "enabled");
        //            msg = String.Format ( "User is {0} successfully", param );
        //        }
        //        else
        //        {
