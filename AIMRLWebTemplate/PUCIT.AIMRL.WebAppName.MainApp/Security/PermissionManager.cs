...
namespace PUCIT.AIMRL.WebAppName.MainApp.Security
{
    public static class PermissionManager
    {
        ...
        public static Boolean perManageSecurityStudents
        {
            get
            {
                if (System.Web.HttpContext.Current.Session["perManageSecurityStudents"] != null)
                    return Convert.ToBoolean ( System.Web.HttpContext.Current.Session["perManageSecurityStudents"] );
                else
                    return false;
            }
            set
            {
                System.Web.HttpContext.Current.Session["perManageSecurityStudents"] = value;
            }
        }
        ...
        public static void HandlePermissions(List<string> permissionStrList)
        {
            ...
            PermissionManager.perManageSecurityStudents = false;
            ...
            if (permissionStrList.Contains ( "PERMANAGESECURITYROLES" ))
                PermissionManager.perManageSecurityStudents = true;
