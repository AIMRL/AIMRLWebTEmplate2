...
namespace PUCIT.AIMRL.WebAppName.MainApp.APIControllers
{
    public class SecurityController : BaseDataController
    {
        ...
        [HttpPost]
        public Object EnableDisableRole(Role r)
        {
        ...
        {
            return Repository.SaveStudent ( std );
        }

        //public object EnableDisableStudent ( Students std )
        //{
        //    return Repository.EnableDisableStudent ( std );
        //}
