...
namespace PUCIT.AIMRL.WebAppName.DAL
{
    public class PRMDataService
    {
        ...
        #region Role
        public int SaveRole(Role role, DateTime pActivityTime, int pActivityBy)
        {
        ...
        public List<Students> GetAllStudents ()
        {
            using (var db = new PRMDataContext ())
            {
                var rv= db.Students.ToList ();
                return rv;
            }
        }


        public int SaveStudent ( Students std, DateTime pActivityTime, int pActivityBy )
        {

            using (var ctx = new PRMDataContext ())
            {
                string query = "execute dbo.SaveStudents @0, @1, @2,@3,@4,@5";
                var args = new DbParameter[] {
                    new SqlParameter { ParameterName = "@0", Value = std.StudentID },
                    new SqlParameter { ParameterName = "@1", Value = std.Name},
                    new SqlParameter { ParameterName = "@2", Value = std.RollNumber},
                    new SqlParameter { ParameterName = "@3", Value = std.DoB.YYYYMMDD()},
                    new SqlParameter { ParameterName = "@4", Value = pActivityTime.YYYYMMDD()},
                    new SqlParameter { ParameterName = "@5", Value = pActivityBy}
                };
        ...
        //public bool EnableDisableStudent ( int pStdID, Boolean pIsActiv, DateTime pActivityTime, int pActivityBy )
        //{
        //    using (var ctx = new PRMDataContext ())
        //    {
        //        string query = "execute sec.EnableDisableUser @0, @1, @2, @3";
        ...
        //        var args = new DbParameter[] {
        //             new SqlParameter { ParameterName = "@0", Value = pStdID},
        //             new SqlParameter { ParameterName = "@1", Value = pIsActiv},
        //            new SqlParameter { ParameterName = "@2", Value = pActivityTime.YYYYMMDD()},
        //            new SqlParameter { ParameterName = "@3", Value = pActivityBy}
        //        };
